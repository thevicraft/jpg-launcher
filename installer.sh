...
if ! [ $1 = "install" ]
then
	echo "Incorrect Argument: exit code 22"
	exit 22
fi
...
then
	echo "Java version --"
	echo $(java -version)
	echo "-- was sucessfully found."
else
	echo "It seems like java is not installed on your system. The game requires a java version higher or equal to java8!"
	echo "The installation will work without java. The game start requires java though. Do you still want to continue installing?"
